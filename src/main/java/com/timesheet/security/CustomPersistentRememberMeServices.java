...
public class CustomPersistentRememberMeServices extends
    ...
    @Inject
    private com.timesheet.repository.PersistentTokenRepository persistentTokenRepository;
    ...
    public CustomPersistentRememberMeServices(Environment env, org.springframework.security.core.userdetails
        ...
        super(env.getProperty("timesheet.security.rememberme.key"), userDetailsService);
