                            ...
                            <ul className="nav navbar-nav navbar-right">
                                ...
                                <li className="dropdown pointer">
                                    ...
                                    <ul className="dropdown-menu">
                                        ...
                                        <li><a><span className="glyphicon glyphicon-plus-sign"></span>
                                ...
                                <li className="dropdown pointer">
                                    ...
                                    <ul className="dropdown-menu">
                                        <li><a><span className="glyphicon glyphicon-user"></span>&#xA0;<span>Team management</span></a></li>
                                        <li><a><span className="glyphicon glyphicon-user"></span>&#xA0;<span>User management</span></a></li>
                                        <li><a><span className="glyphicon glyphicon-dashboard"></span>&#xA0;<span>Metrics</span></a></li>
                                        <li><a><span className="glyphicon glyphicon-heart"></span>&#xA0;<span>Health</span></a></li>
                                        <li><a><span className="glyphicon glyphicon-list-alt"></span>&#xA0;<span>Configuration</span></a></li>
                                        <li><a><span className="glyphicon glyphicon-bell"></span>&#xA0;<span>Audits</span></a></li>
                                        <li><a><span className="glyphicon glyphicon-tasks"></span>&#xA0;<span>Logs</span></a></li>
                                        <li><a><span className="glyphicon glyphicon-book"></span>&#xA0;<span>API</span></a></li>
                                        <li><a href='/h2-console'><span className="glyphicon glyphicon-hdd"></span>&#xA0;<span>Database</span></a></li>
                                    </ul>
                                </li>
                                <li className="dropdown pointer">
